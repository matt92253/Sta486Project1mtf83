#' Math and Portugese survey data from two Portugese schools
#'
#' @format a data frame with 1044 observations( currently contains duplicates)
#' \describe{
#'   \item{school}{ student's school "GP" - Gabriel Pereira or "MS" - Mousinho da Silveira}
#'   \item{sex}{ student's sex: M or F }
#'   \item{age}{ students age: 15 to 22 }
...
#'   \item{Walc}{ weekend alcohol consumption: from 1 - very low to 5 - very high}
#'   \item{health}{ current health status: from 1 - very bad to 5 - very good}
#'   \item{absences}{ number of school absences: from 0 to 93}
